...
export default function DashboardPage() {
  ...
  const { subscriptions, load: loadSub, loaded: subLoaded } = useSubscriptionStore()
  const { settings, setBaseCurrency, load: loadSettings, loaded: settLoaded } = useSettingsStore()
