  ...
  return (
    <div style={{ position:'fixed', inset:0, zIndex:200, pointerEvents:open?'auto':'none' }}>
      ...
      <div style={{
        ...
        /* bottom padding covers iOS home indicator */
...
/* fieldBase height is explicitly 50px so ALL inputs — text, number, date, select — are identical on iOS */
  ...
  return (
    <button
      ...
      style={{
        ...
        cursor: 'pointer',
        zIndex: 50,
        boxShadow: '0 4px 20px rgba(91,91,214,0.45)',
        display: 'flex',
        alignItems: 'center',
